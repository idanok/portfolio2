    ...
    <div className="min-h-screen bg-[#FAF6F0]">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-8">
          ...
          <h1 className="font-serif text-3xl font-semibold text-[#3D2314] mt-2 mb-4">CSS Frameworks</h1>
          ...
          <div className="flex gap-4 mb-10">
            <a href="https://velvety-gecko-f8c911.netlify.app/" target="_blank" rel="noopener noreferrer" className="text-sm font-medium bg-[#3D2314] text-white px-4 py-2 rounded-xl hover:bg-[#2d4460] transition-colors">View Live Site ↗</a>
            <a href="https://github.com/idanok/js2-css-frameworks/blob/main/README.md" target="_blank" rel="noopener noreferrer" className="text-sm font-medium border border-[#E8E4DE] text-[#3D2314] px-4 py-2 rounded-xl hover:border-[#3D2314] transition-colors">GitHub README ↗</a>
          </div>
